...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    //That query method will return a list with users from the database, searching by firstname.
    List<User> findByFirstName(String firstName);

    //That query method will return a list with users from the database, searching by lastname.
    List<User> findByLastName(String lastName);

    //That query method will return a list with users from the database, searching by firstname and lastname.
    ...
    //That query method will return a list with users from the database, searching by created date.
    List<User> findByCreatedDate(LocalDate createdDate);

    //That query method will return a list with users from the database, searching by their role.
